...
<input className='mr-3 px-2 py-2.5 md:px-11 focus:outline-none rounded-lg' style={{border: "1px solid #bfbfbf"}} type='text' placeholder='Number of votes'/>
<select className='px-2 py-2.5 md:px-11 rounded-lg focus:outline-none' style={{border: "1px solid #bfbfbf"}} name="" id="" placeholder='Amount'>
